...
class ObjectDetector {
  ...
  Map<String, dynamic> predict(ImageLib.Image image) {
      ...
      debugPrint(outputLocations.getDoubleValue(0).toString());
      ...
      for (int i = 0; i < numResults; ++i) {
        ...
        if (score > THRESHOLD) {
          var top = outputLocations.getDoubleList()[0 + i * 4];
          var left = outputLocations.getDoubleList()[1 + i * 4];
          var bottom = 300 - top - outputLocations.getDoubleList()[2 + i * 4];
          var right = 300 - left - outputLocations.getDoubleList()[3 + i * 4];

          var testRect = Rect.fromLTRB(left, top, right, bottom);
          var testTransformRect = _imageProcessor!.inverseTransformRect(
              testRect, image.height, image.width
          );
